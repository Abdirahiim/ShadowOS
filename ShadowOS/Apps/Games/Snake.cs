...
namespace Shadow_OS.Apps.Games
{
    class Snake
    {
        /* SNAKE VARS */
        public static int[] matrix;
        public static List<int[]> commands;
        ...
        /* SNAKE FUNCS */
        public static string getSnakeScore()
        {
            if (snake.Count < 10)
            {
                return snake.Count + "   ";
        ...
        public static void updatePosotion()
        {
        ...
        public static int xy2p(int x, int y)
        {
            return y * 80 + x;
        }
        ...
        public static void configSnake()
        {
            matrix = new int[1760];
        ...
        public static void checkIfTouchFood()
        {
